...
public class TwoPairsHandAnalyzerTest {
    private IHandAnalyzer twoPairsHandAnalyzer = new TwoPairsHandAnalyzer();
    @Test
    public void getHandTest() throws Exception {
        List<Card> cards = new ArrayList<>();
        Card card2 = new Card(SuitEnum.HEART, "2");
        Card card3 = new Card(SuitEnum.DIAMOND, "2");
        Card card4 = new Card(SuitEnum.CLUB, "3");
        ...
        IHand hand = twoPairsHandAnalyzer.getHand(player);
        assertTrue(hand instanceof TwoPairsHand);
    }

    @Test
    public void analyzeReturnTwoPairsHand() throws Exception {
        List<Card> cards = new ArrayList<>();
        Card card2 = new Card(SuitEnum.HEART, "2");
        Card card3 = new Card(SuitEnum.DIAMOND, "2");
        Card card4 = new Card(SuitEnum.CLUB, "3");
        ...
        cards.add(card6);
        Player player = new Player("black", cards);
        IHand hand = twoPairsHandAnalyzer.analyze(player);
        assertTrue(hand instanceof TwoPairsHand);
    }

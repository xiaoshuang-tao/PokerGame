...
public class PairHandAnalyzerTest {
    private IHandAnalyzer pairHandAnalyzer = new PairHandAnalyzer();
    @Test
    public void getHandTest() throws Exception {
        ...
        IHand hand = pairHandAnalyzer.getHand(player);
        assertTrue(hand instanceof PairHand);
    }

    @Test
    public void analyzeReturnPairHand() throws Exception {
        List<Card> cards = new ArrayList<>();
        Card card2 = new Card(SuitEnum.HEART, "2");
        Card card3 = new Card(SuitEnum.DIAMOND, "2");
        Card card4 = new Card(SuitEnum.CLUB, "3");
        ...
        cards.add(card6);
        Player player = new Player("black", cards);
        IHand hand = pairHandAnalyzer.analyze(player);
        assertTrue(hand instanceof PairHand);
    }

...
public class FourKindHandTest {
    private IHand hand = new FourKindHand();
    @Test
    public void getTypeTest(){
        assertEquals(PokerHandTypeEnum.FOUR_KIND,hand.getType());
    }
    @Test
    public void compareReturnOne() throws Exception{
        ...
        p1Cards.add(new Card(SuitEnum.CLUB,"7"));
    ...
    public void compareReturnMinusOne() throws Exception {
        ...
        p1Cards.add(new Card(SuitEnum.CLUB,"2"));
        p1Cards.add(new Card(SuitEnum.HEART,"6"));
        Player p1 = new Player("Black",p1Cards);
